...
pub fn load_fbx_rigged_print_attributes() {
  ...
  let fbx = alers::resource::fbx::load("resources/test/anim_begin.fbx").expect("Fail to load rigged fbx");
...
pub fn load_fbx_rigged_convert_print_attributes() {
  ...
  let fbx = alers::resource::fbx::load("resources/test/spheres.fbx").expect("Fail to load rigged fbx");
